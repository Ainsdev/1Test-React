  ...
  return (
    <div className="w-screen sm:py-4 sm:px-24 bg-gradient-to-t from-pink-300 via-purple-300 to-indigo-400
      ...
      <section className='text-center flex justify-center'>
        <img className='sm:w-1/2 sm:rounded-2xl sm:hover:-translate-y-2 sm:hover:translate-x-1 sm:ring-white ring-1' src="src\assets\OOjs_UI_icon_userAvatar.svg.png" />
      </section>
      <Name />
      <About />
    </div>
